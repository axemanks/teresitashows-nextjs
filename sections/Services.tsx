...
const Services = (props: Props) => {
  return (
    ...
    >
      ...
      <p className='base-regular text-center text-green-500 text-xl'>
        Llevamos alegría y el mejor entretenimiento a tu hogar o evento, escoge
        tu personaje favorito y que empiece la diversión!
      </p>
      {/* services - gallery */}
      <div className='flex flex-row flex-wrap justify-between gap-0.5 w-full '>
        <div>
          <Image
            src='/muneca-y-payasito.jpg'
            height={250}
            width={250}
            alt='muneca-y-payasito'
            id='muneca-y-payasito'
